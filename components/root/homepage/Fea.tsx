        ...
        <div className="text-white">
            <div className="text-center text-white space-y-4 px-10 mb-12">
                ...
                <p className="text-muted-foreground text-lg md:text-xl max-w-3xl mx-auto">
                    Dream UI offers a versatile range of services and high-quality UI components that help you build stunning user interfaces quickly and efficiently.
                </p>
            </div>
